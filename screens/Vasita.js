        ...
        <ScrollView>
            <TouchableOpacity onPress={() => navigation.navigate('Categories')}>
                <View style={{ flexDirection: 'row', padding: 10, alignItems: 'center', paddingTop: 17, borderBottomWidth: 1, borderColor: '#ccc', paddingBottom: 17 }}>
                    <View>
                        <Text style={{ fontSize: 16, color: '#1679AB' }}>Tum "Vasita" Ilanlari</Text>
                    </View>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Categories')}>
                <View style={{ flexDirection: 'row', padding: 10, alignItems: 'center', paddingTop: 17, borderBottomWidth: 1, borderColor: '#ccc', paddingBottom: 17 }}>
                    <View>
                        <Text style={{ fontSize: 16, color: '#000' }}>Otomobil</Text>
                    </View>
                    <View style={{ flex: 1, alignItems: 'flex-end' }}>
                        <View style={{ display: 'flex', flexDirection: 'row' }}>
                            <Text style={{ fontSize: 13, position: 'relative', right: 10, color: '#888' }}>(523.534)</Text>
